Locales['en'] = {
	...
	['pickup_in_prog'] = '~y~Collecting drugs~s~...',
	...
	['no_pouchs_sale'] = 'You have no more bags for ~r~sale~s~',
	...
	['sold_one_weed'] = 'you\'ve sold ~g~x1 Weed bag(10G)~s~',
	...
	['exit_marker'] = 'Press ~INPUT_INTERACT~ to cancel the ~y~process~s~',
